...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="../images/colombo_30.jpg" alt="The Hotel" style="min-width:1000px" width="1500" height="800">
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div  class="w3-container w3-blue" >
      <h2><img src="../images/logo_white.png" style="width: 40px;height: 40px;margin-right: 20px;">Welcome</h2>
    </div>
  </div>
</header>
